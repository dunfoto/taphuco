    ...
    return (
        <React.Fragment>
            <div className="context">
                ...
                {lstNode.length > 0 && lstNode.map((node, i) => (
                    <div key={i}>
                        <Popover
                            isOpen={show == node._id}
                            position={['top', 'right', 'left', 'bottom']}
                            padding={10}
                            // disableReposition
                            onClickOutside={() => clickHotSpot(null)}
                            content={({ position, nudgedLeft, nudgedTop, targetRect, popoverRect }) => (
                                <div className="card p-0 text-left w-75 ml-auto hotspot-homepage">
